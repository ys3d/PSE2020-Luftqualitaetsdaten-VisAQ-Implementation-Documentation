...
{
	name=Leaflet,
	description={Leaflet ist eine freie JavaScript-Bibliothek, mit der Webanwendungen erstellt werden können. Die Bibliothek unterstützt die meisten Desktop- und Mobil-Browser.}
}

\newglossaryentry{Bootstrap}
{
	name=Bootstrap,
	description={Eine Bibliothek um Frontendkomponenten zu implementieren}
}

\newglossaryentry{React-Lifecycle}
{
	name={React-Lifecycle},
	description={Eine Funktion von React die es erlaubt mithilfe von mehreren Methoden einzelne Komponenten zu aktualisieren.}
}