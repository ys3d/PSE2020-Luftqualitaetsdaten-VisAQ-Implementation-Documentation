...
\newcommand{\removedClass}{Diese Klasse wurde aufgrund von React entfernt}
\newcommand{\standardMethods}{shouldComponentUpdate(), componentDidUpdate(), componentDidMount(), componentWillMount()}
